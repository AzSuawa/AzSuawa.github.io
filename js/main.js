            ...
            <div class="card active error">
                ...
                <div class="command-section">
                    ...
                    <div style="margin-top:15px">
                        <button onclick="location.reload()" style="margin:5px;padding:6px 15px;background:#8CAEFF;color:white;border:none;border-radius:4px;cursor:pointer;font-size:15px">刷新</button>
                    </div>
                </div>
            </div>
        `;
