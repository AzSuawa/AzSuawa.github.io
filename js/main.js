            ...
            <div class="card active error">
                ...
                <div class="command-section">
                    ...
                    <div style="margin-top:15px">
                        <button onclick="location.reload()" style="margin:5px;padding:8px 16px;background:#8CAEFF;color:white;border:none;border-radius:4px;cursor:pointer;font-size:14px">刷新</button>
                    </div>
                </div>
            </div>
        `;
